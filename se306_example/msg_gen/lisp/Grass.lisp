...
;//! \htmlinclude Grass.msg.html

(cl:defclass <Grass> (roslisp-msg-protocol:ros-message)
  ((robot_name
    :reader robot_name
    :initarg :robot_name
    :type cl:string
...
(cl:defclass Grass (<Grass>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <Grass>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'Grass)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name se306_example-msg:<Grass> is deprecated: use se306_example-msg:Grass instead.")))

(cl:ensure-generic-function 'robot_name-val :lambda-list '(m))
(cl:defmethod robot_name-val ((m <Grass>))
...
(cl:defmethod py-val ((m <Grass>))
  ...
  (py m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Grass>) ostream)
  "Serializes a message object of type '<Grass>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Grass>) istream)
  "Deserializes a message object of type '<Grass>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Grass>)))
  "Returns string type for a message object of type '<Grass>"
  "se306_example/Grass")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Grass)))
  "Returns string type for a message object of type 'Grass"
  "se306_example/Grass")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Grass>)))
  "Returns md5sum for a message object of type '<Grass>"
  "82eb8202e95e71eede1f9a296896b7d3")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Grass)))
  "Returns md5sum for a message object of type 'Grass"
  "82eb8202e95e71eede1f9a296896b7d3")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Grass>)))
  "Returns full string definition for message of type '<Grass>"
  (cl:format cl:nil "string robot_name~%int64 px~%int64 py~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Grass)))
  "Returns full string definition for message of type 'Grass"
  (cl:format cl:nil "string robot_name~%int64 px~%int64 py~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <Grass>))
  (cl:+ 0
     4 (cl:length (cl:slot-value msg 'robot_name))
     8
     8
))
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <Grass>))
