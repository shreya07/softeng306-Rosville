 ...
 *  */
Gate::Gate(std::string robot_name, int argc, char **argv):Robot(robot_name,argc,argv)
{
...
ros::NodeHandle Gate::run(){
  ...
  ros::Subscriber GateListener = n.subscribe<std_msgs::String>("/toggleGate/"+robot_name,1000, &Gate::Gate_callback, this);
