...
void Robot_1_Velociy_callback(geometry_msgs::Twist msg)
{
...
ros::Subscriber Robot_1_Vel = n.subscribe<geometry_msgs::Twist>("robot_1/cmd_vel",1000,Robot_1_Velociy_callback);
